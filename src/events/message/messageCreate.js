  ...
  if (message.content.startsWith(client.user.toString())) {
    ...
    if (!messageContent) {
      const embed = new EmbedBuilder()
        ...
        .setDescription(`Yoo, ${message.author}! It seems like you summoned me. My prefix for this server is " \`${settings.prefix}\` " . Use \`${settings.prefix}help\` to see all my commands!`)
